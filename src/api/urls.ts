//auth
export const POST_FAKE_LOGIN = "/v1/auth/login";
export const GET_TOPICS = "v1/topics";
export const ADD_TOPICS = "v1/topics";
export const GET_AGENTS = "v1/users";
export const ADD_AGENTS = "v1/users";
